...
const Hero = forwardRef<HTMLDivElement, Ifunc>(
  ({ onClick, SetActiveIndex, activeIndex, onInViewChange, id }, ref) => {
    ...
    return (
      <div ref={combinedRef} className="w-full h-[1200px]">
        ...
        <div className="absolute z-[-2] top-[768px] bg-[url('/Hero.svg')] bg-cover bg-center bg-no-repeat w-full h-[926px]">
        ...
        <div id={id} className="mt-[187px] flex justify-center items-center">
          ...
          <div className="mr-auto flex flex-col w-[950px] h-[310px] justify-center items-start gap-[10px]">
            ...
            <a
              className="flex gap-[15px] hover:cursor-pointer"
              data-scroll
              href="#01"
