  ...
  (
    ...
    return (
      <div
        ...
        } justify-between items-center w-[1462px] h-[720px] mt-[100px]`}
      >
        <div
          className={`absolute z-[10] top-[38px] ${
            Inversion ? "right-[550px]" : ""
          } text-[240px] text-white font-bold leading-[240px] opacity-[5%] w-[240px] h-[240px]`}
        >
          {Number}
        </div>
        ...
        <div className="relative flex flex-col z-[20] w-[632px] h-[439px] ml-[150px] gap-[30px]">
          ...
          <div className="text-[18px] text-white font-bold w-[632px] h-[160px]">
            {Description}
          </div>
          ...
          <div className="flex gap-[15px]">
            <Link
              href="/SomePage"
              className="text-CustomLightText font-bold hover:cursor-pointer"
            >
              read more
            </Link>
            <Image
